...
replace (
	github.com/drfaust92/terraform-provider-airflow/shim => ./shim
...
require (
	...
	github.com/drfaust92/terraform-provider-airflow/shim v0.12.4
...
require (
	...
	github.com/drfaust92/terraform-provider-airflow v0.12.4 // indirect
